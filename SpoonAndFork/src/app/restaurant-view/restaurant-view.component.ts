...
export class RestaurantViewComponent {
  ...
  getItems(id:number) {
    ...
    onSearchTextChanged(searchText:string) {
                ...
                if(searchText || searchText !== ''){
                  this.present=true;
                  this.searchedLocation=this.restaurants.filter((restaurant:any)=>{
                      return restaurant.location.toLowerCase().includes(searchText.toLowerCase());
                    });
                }else{
                  this.present=false;
                ...
                console.log(this.restaurants,"restaurant");
